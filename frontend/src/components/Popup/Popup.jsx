			...
			<div className={s.popup_registr_authoriz}>
				<div className="wrapper_popup">
					<div className={s.user_info}>
						{userChannel.logo ? <img src={userChannel.logo} alt="profile" style={{width: '32px', height: '32px', borderRadius: '50%'}}/>
						:
							<svg
								...
								viewBox="0 0 50 50"
								// width="40px"
								style={{width:'32px',height:'32px', fill: '#fff',marginRight: '10px'}}
							>
								<circle
									cx="25"
									cy="25"
